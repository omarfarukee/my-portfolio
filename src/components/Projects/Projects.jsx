...
import img5 from '../../assets/project img/img5.jpg'
import img6 from '../../assets/project img/img6.jpg'
            ...
            <div className={full}>
                <div className='flex flex-col items-center lg:items-start lg:flex-row lg:mt-16 mt-28 lg:justify-evenly' data-aos="fade-down">
                    <div className='mb-20 lg:ml-3 p-card'>
                        ...
                        <h1 className='flex justify-center text-2xl font-bold '>Features</h1>
                            ...
                            <div className='flex justify-between gap-2 p-2 lg:justify-start'>
                                ...
                                <button className='w-32 p-1 bg-blue-900 rounded-md'><a href="https://github.com/RakibulHasan2/gadget-sailor-frontend" target='_blank' className='flex items-center justify-center gap-2 text-white'><FaGithub />Client Repo</a></button>
                            </div>
                            <div className='flex justify-center'>
                                <button className='w-32 p-1 bg-blue-900 rounded-md'><a href="https://github.com/RakibulHasan2/gadget-sailor-backend" target='_blank' className='flex items-center justify-center gap-2 text-white'><FaGithub />Server Repo</a></button>
                            </div>
                        </div>
                    ...
                    <div className=' lg:ml-3 p-card'>
                        <div className='p-circle' style={{ '--clr': '#bdde63' }}>
                            <img src={quiz} alt="" className='w-20 rounded-lg p-logo' />
                        </div>
                        <div className='p-3 p-content'>
                            <h1 className='flex justify-center text-2xl font-bold text-white'>Features</h1>
                            <small className='text-black'>
                                <li>Built a dynamic quiz app with engaging content across 6 topics for active learning.</li>
                                <li>Streamlined student participation in quizzes and empowered teachers to create topic-specific questions.</li>
                                <li>Focused on intuitive navigation and provided immediate feedback to students.</li>
                                <li>Implemented secure login and session storage to protect user privacy.</li>
                            </small>
                            <div className='flex justify-between gap-2 p-2 lg:justify-start'>
                                <button className='w-32 p-1 rounded-md bg-lime-600'><a href="https://quiz-client-rakibulhasan2s-projects.vercel.app/" className='flex items-center justify-center gap-2 text-white' target='_blank'><FaEye />Link</a></button>
                                <button className='w-32 p-1 rounded-md bg-lime-600'><a href="https://github.com/RakibulHasan2/quiz-client" target='_blank' className='flex items-center justify-center gap-2 text-white'><FaGithub />Client Repo</a></button>
                            </div>
                            <div className='flex justify-center'>
                                <button className='w-32 p-1 rounded-md bg-lime-600'><a href="https://github.com/omarfarukee/quiz-app-server" target='_blank' className='flex items-center justify-center gap-2 text-white'><FaGithub />Server Repo</a></button>
                            </div>
                        </div>
